...
const NotificationSheet: React.FC = () => {
  ...
  const notifications = [
    ...
    },
    {
      ...
      title: "Kampanye Baru",
      message:
        "Kami telah meluncurkan kampanye wakaf baru. Segera cek detailnya di halaman kampanye.",
      time: "1 month ago",
      icon: <BiSolidNews className="text-blue-500" />, 
    },
    {
      id: 3,
      title: "Pembayaran Gagal",
      message:
        "Pembayaran Anda untuk kampanye wakaf gagal diproses. Silakan coba lagi atau hubungi dukungan pelanggan.",
      time: "2 weeks ago",
    ...
    },
    {
      ...
      message:
        "Sertifikat Anda telah dikirimkan dan ditambahkan ke halaman profil Anda. Terima kasih atas partisipasi Anda dalam kampanye wakaf.",
      time: "1 day ago",
    ...
    },
    {
      ...
      message:
        "Kampanye wakaf yang Anda ikuti telah selesai. Terima kasih atas partisipasi Anda.",
      time: "3 days ago",
                  ...
                  <div className="p-4 space-y-4 text-start">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h2 className="sm:text-lg font-semibold text-black">
              ...
              <AccordionItem value="item-campaigns">
                <AccordionTrigger>
                  <div className="flex items-center space-x-3 w-full rounded-lg">
                    <div className="relative">
                      <div className="bg-blue-500 p-3 rounded-xl">
                        <MdOutlineCampaign className="text-white text-xl" />{" "}
                        {/* Icon for new campaign */}
                      </div>
                      <div className="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 bg-white rounded-full p-1">
                        {notifications[1].icon}
                      </div>
                    </div>
                    <div className="text-start">
                      <h2 className="sm:text-lg font-semibold">
