      ...
      <div className={cn("bg-background rounded-md shadow-sm p-4", className)}>
        ...
        <div className="grid grid-cols-2 gap-x-2 sm:gap-x-4 gap-y-2 sm:gap-y-4 ">
          ...
          <div className="col-span-2 p-4 rounded-md bg-muted">
            <p className="text-xs">
              <b>Disclaimer:</b> Kampanye ini diadakan secara resmi oleh
              pengurus dari Pondok Pesantren Mahasiswa Al-Ihsan dan menjadi
              tanggung jawabnya. Jika ada masalah atau kecurigaan silahkan{" "}
              <a href="#" className="text-secondary underline">
                laporkan kepada pihak pengembang.
              </a>
            </p>
          </div>
        </div>
